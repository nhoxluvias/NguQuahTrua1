    ...
    <div class="row grid-responsive">
        <div class="column page-heading">
            <div class="large-card">
                <h1>Chi tiết quốc gia: <% = countryInfo.name %></h1>
                <p>ID của quốc gia: <% = countryInfo.ID %></p>
                <p>Tên của quốc gia: <% = countryInfo.name %></p>
                <p>Mô tả của quốc gia: <% = countryInfo.description %></p>
                <p>Ngày tạo của quốc gia: <% = countryInfo.createAt %></p>
                <p>Ngày cập nhật của quốc gia: <% = countryInfo.updateAt %></p>
